...
import io.github.mooninaut.studentplanner.database.CourseCursorAdapter;
...
//    private static final String WHEN = "when";
    ...
    private Assessment editAssessment(Uri assessmentUri) {
        ...
        try {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                ...
                TextView startTimeTV = findViewById(R.id.edit_start_time);
                TextView endTimeTV = findViewById(R.id.edit_end_time);
                ...
                Spinner typeSpinner = findViewById(R.id.spinner_assessment_type);
    ...
    public void createAssessment(View view) {
        ...
        Spinner type = findViewById(R.id.spinner_assessment_type);
        ...
        if (resultUri != null) {
            Intent result = new Intent("io.github.mooninaut.studentplanner.RESULT_ASSESSMENT", resultUri);
